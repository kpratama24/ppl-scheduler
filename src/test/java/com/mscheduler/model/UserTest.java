...
public class UserTest {
    ...
    public void testSetEmail() {
        ...
        String email = "prayogo@gmail.com";
        User instance = new User();
        instance.setEmail(email);
        
        System.out.println("getEmail");
        String expResult = "prayogo@gmail.com";
    ...
    public void testBooleanReadUser() {
        ...
        String input = "prayogo@gmail.com";
        User instance = new User();
        boolean expResult = false;
    ...
    public void testCheckdel() {
        ...
        User instance = new User("prayogo@gmail.com", "password", "prayogo", false);
