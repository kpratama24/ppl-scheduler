...
public class ListMeetingViewModelTest {
    ...
    public void testSetMeeting_id() {
        ...
        int meeting_id = 0;
        ListMeetingViewModel instance = new ListMeetingViewModel(meeting_id, "Rapat mahasiswa", MeetingStatus.negotiating);
    ...
    public void testSetMeeting_title() {
        ...
        String meeting_title = "Rapat LKM";
    ...
    public void testSetMeetingStatus() {
        ...
        ListMeetingViewModel instance = new ListMeetingViewModel(0, "Rapat mahasiswa", meeting_status);
