...
//
    ...
    public void testCreateMeeting(){ //Boundary
        ...
        participants1.add("Kevin,Stillmen,Prayogo");
        List<String> important_participants1 = new ArrayList();
        participants1.add("Pak Claudio");
        List<String> participants2 = new ArrayList();
        List<String> important_participants2 = new ArrayList();
        Meeting m1 = new Meeting(10,"Rapat Skripsi","Membahas skripsi", "9014", 2, new DateRange("02-06-2017 - 31-12-2017"), new Date(),participants1,important_participants1, MeetingStatus.negotiating,
        new DateRange("02-06-2017 - 31-12-2017"),false);
        Meeting m2 = new Meeting(10,"Rapat Skripsi","Membahas skripsi", "9014", 2, new DateRange("02-06-2017 - 31-12-2017"), new Date(),participants2,important_participants2, MeetingStatus.negotiating,
        new DateRange("02-06-2017 - 31-12-2017"),false);
